...
check_service "cac-orchestrator" "http://localhost:3001/health"
check_service "slack-bot"        "http://localhost:3003/health"
check_service "rag-ingestion"    "http://localhost:3004/health"
check_service "approval-ui"      "http://localhost:4000/api/health"
check_service "paperclip"        "http://localhost:3100/health"
check_service "wiki-compiler"    "http://localhost:3007/health"
check_service "sync-mirror"      "http://localhost:3008/health"
