...
Prediction-market venue to be onboarded for the **$50k prediction-market arbitrage pilot** (Engine 3).

## Role

- Named in the May 2026 deck Action & Approval list (slide 26) and the IC minutes (Objective #6) as one of four prediction-market venues for which accounts will be opened.

## Related

- [[prediction-market-pilot]] — the $50k pilot programme
- [[option-wheel-prediction-markets]] — Engine 3 umbrella objective
- [[kalshi]] · [[polymarket]] · [[pump-fun]] — fellow pilot venues
