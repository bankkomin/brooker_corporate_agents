---
title: "Sukhothai Redemption Plan"
type: "decision_log"
department: "ic"
status: "ongoing"
...
# Sukhothai Redemption Plan

## Decision

Run a phased redemption from the [[sukhothai-fund]] toward a steady **2 mn USD / year** drawdown to support the [[investment-holding-limit]] reduction and free liquidity.

## Status timeline

| Meeting | Status | Amount | Notes |
|---------|--------|--------|-------|
| 2024 Q4 | **Paused** | — | Q4 redemptions paused |
...
- Reduce concentrated USD fund exposure
- Free liquidity for [[investment-holding-limit]] rebalance (binding 30 Jun 2026)
- Preserve performance optionality (Sukhothai is the only positive YTD line in 2026 so partial-pause defensible)

## Related

- [[sukhothai-fund]] — entity record with AUM history
- [[investment-holding-limit]] — driving constraint
- [[liquidity-management-policy]] — unlocked-funds component
