---
title: "Investment Holding 40% Rebalance"
type: "decision_log"
department: "ic"
status: "ongoing_critical"
deadline: "2026-06-30"
...
# Investment Holding 40% Rebalance

## Decision

Bring `Investment / Total Assets` below the **40% regulatory cap** by **30 June 2026** (end of the 2-year BoT grace period).
...
1. **[[sukhothai-redemption]]** — 2 mn USD/year drawdown
2. **[[digital-asset-treasury-divestment]]** — Phased BTC/BNB sale
3. **[[red-flag-portfolio-reduction]]** — MILL/PACE/Wave/B reduction
4. **Sell + call option** strategy on overweight positions (Mar 2026 plan)
5. **Strategic / synergy / value-chain carve-out** — proposed; **value-chain carve-out denied** by regulator

## Rationale

- Hard regulatory deadline (BoT grace expires)
- No new investment permitted during grace
- Crossing it post-grace draws supervisory action

## Related

- [[investment-holding-limit]] — concept file (definition + history)
- All four reduction levers above
