...
Capital Allocation & ALCO Committee knowledge base. Concepts, decisions, meeting notes, entities, and trends specific to the CAC department.
...
- **Concepts** — `cac/concepts/` — Foundational domain knowledge articles
- **Decisions** — `cac/decisions/` — Recorded committee decisions
- **Meeting Notes** — `cac/meeting-notes/` — ALCO meeting records
- **Entities** — `cac/entities/` — Key counterparties, facilities, instruments
- **Trends** — `cac/trends/` — Market and portfolio trend analysis

## Operations Log

- [[cac/log|Operations Log]]
